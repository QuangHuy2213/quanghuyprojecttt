...
export default function CreatePostPage() {
  ...
  // 🌟 FORM DATA ĐÃ ĐẦY ĐỦ CÁC TRƯỜNG CỦA BẠN
  ...
  // Kiểm tra đăng nhập và phân quyền khi vừa vào trang
  useEffect(() => {
    ...
    // Kiểm tra quyền: Chỉ Agent hoặc Admin mới được đăng tin
    if (parsedUser.role !== 'AGENT' && parsedUser.role !== 'ADMIN') {
      showToast('Tài khoản của bạn cần nâng cấp lên Môi giới (Agent) để đăng tin!', 'error');
      setTimeout(() => {
        router.push('/');
      }, 2000);
      return;
        ...
        <div className="bg-white/80 backdrop-blur-2xl py-12 px-8 sm:px-12 shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-[2.5rem] border border-white transition-all hover:shadow-[0_8px_40px_rgb(0,0,0,0.12)]">
          ...
          <div className="text-center mb-10">
            <span className="inline-block bg-gradient-to-r from-[#1877F2] to-blue-500 text-white font-extrabold text-sm px-6 py-2 rounded-2xl shadow-lg shadow-blue-500/30 tracking-tight mb-4">
              {user.role === 'ADMIN' ? 'QUẢN TRỊ VIÊN' : 'MÔI GIỚI BẤT ĐỘNG SẢN'}
            </span>
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full bg-white/60 border border-gray-200 rounded-2xl pl-12 pr-4 py-4 text-sm text-gray-800 focus:outline-none focus:ring-4 focus:ring-[#1877F2]/10 focus:border-[#1877F2] focus:bg-white transition-all font-medium"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <div className="relative group">
                  ...
                  <select 
                    required 
                    className="w-full bg-white/60 border border-gray-200 rounded-2xl pl-12 pr-4 py-4 text-sm text-gray-700 focus:outline-none focus:ring-4 focus:ring-[#1877F2]/10 focus:border-[#1877F2] focus:bg-white transition-all font-medium cursor-pointer appearance-none"
                    value={formData.city} 
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <select 
                    ...
                    className={`w-full border border-gray-200 rounded-2xl pl-12 pr-4 py-4 text-sm font-medium transition-all appearance-none ${!formData.city ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white/60 text-gray-700 cursor-pointer focus:outline-none focus:ring-4 focus:ring-[#1877F2]/10 focus:border-[#1877F2] focus:bg-white'}`}
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <textarea 
                  ...
                  className="w-full bg-white/60 border border-gray-200 rounded-2xl pl-12 pr-4 py-4 text-sm text-gray-800 focus:outline-none focus:ring-4 focus:ring-[#1877F2]/10 focus:border-[#1877F2] focus:bg-white transition-all font-medium resize-none"
